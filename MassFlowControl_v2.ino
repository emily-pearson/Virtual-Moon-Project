...
#define tempRegulationPeriod 7200000 // time period (in ms) for temperature regulation to run
...
//timing variable - might not need to be global? due to printFlag
...
// perform system purge using nitrogen flow through the bypass line
digitalWrite(RELAY_1,LOW);
digitalWrite(RELAY_2,HIGH);
delay(10000); // delay is blocking, but that is desired behaviour here
